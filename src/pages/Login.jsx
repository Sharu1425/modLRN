    ...
    function Login({ setUser }) {
        ...
        useEffect(() => {
            ...
            if (userId && email) {
                const user = { _id: userId, email, name };
                setUser(user);
        ...
        const handleSubmit = async (e) => {
            ...
            if (tab === "email") {
                try {
                    const response = await axios.post("http://localhost:5001/db/users/login", 
                        { email, password },
                ...
                setError("Face login not implemented yet");
            }
        };
                    ...
                    >
                        <div className="glass-card p-8 rounded-2xl neon-border shadow-xl backdrop-blur-xl border-1 relative overflow-hidden">
                            ...
                            >
                                ...
                                <p className="text-purple-200 text-lg">Continue your learning journey</p>
                            </motion.div>

                            <div className="relative mb-8">
                                <div className="flex justify-between p-1 bg-purple-900/30 rounded-xl">
                                    <button
                                        onClick={() => setTab("email")}
                                        className={`flex-1 px-6 py-3 rounded-lg transition-all duration-300 relative ${
                                            tab === "email" 
